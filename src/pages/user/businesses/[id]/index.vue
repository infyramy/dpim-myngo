  ...
  <div class="space-y-6">
    ...
    <div v-if="isLoading" class="flex items-center justify-center py-12">
      <div class="flex items-center gap-2">
        ...
        ></div>
        <span class="text-muted-foreground">Loading business data...</span>
      </div>
    </div>
    ...
    <div v-else-if="error" class="text-center py-12">
      <div class="bg-destructive/10 p-6 rounded-lg">
        ...
        <Button @click="goBack" class="mt-4"> Back to Businesses </Button>
      </div>
    </div>
    ...
    <template v-else>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update your business details below. All required fields must be
            filled.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="md:col-span-2">
                ...
                <Input
                  ...
                  @update:model-value="
                    (value) => (formData.url = String(value))
                  "
...
// Business composable
const { isSubmitting, validateBusinessForm, businessToFormData } =
  useBusiness();

// Local state
const isLoading = ref(false);
const error = ref<string | null>(null);
const originalBusiness = ref<Business | null>(null);
...
const loadBusiness = async () => {
  try {
    ...
    formData.value = businessToFormData(response.data.business);
  } catch (err: any) {
...
const handleSubmit = async () => {
  ...
  if (!originalBusiness.value) return;
